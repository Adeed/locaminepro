    ...
    <main>
        <div class="container">
            <form action = "" method="post">             
                ...
                <button class="btn green sf" name="SubmitButton" type="submit">Add Deposits</button>
            </form>
<?php 
...
if(isset($_POST['SubmitButton'])){    
    if(!empty($_POST['amnt'])){
      ...
      $amnt = mysqli_real_escape_string($db,$_POST['amnt']);
        ...
        $registerquery = mysqli_query($db, "INSERT INTO transactions (userID, transType, transDate, transAmnt, transStatus) VALUES('".$userid."', 'Deposit', '".$date."', '".$amnt."', 'Un-Verified')");
        if($registerquery){        
