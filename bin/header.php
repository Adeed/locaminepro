...
<div id="menu">
    <div class="container">
      ...
      { ?>
      <li><a class="sf-b red" href="sign-in.php">Login</a></li>
      ...
      <li><a class="sf-b red" href="../transactions.php">Transactions</a></li>
        ...
        <li><a class="sf-b red" href="logout.php">Logout</a></li>
      <?php
      } 
      ?>
...
<div id="hero" class="home">
    <div class="container">
        ...
        <a href="sign-up.php" class="btn green big sf-b">Get started now</a>
    </div>
    <?php
    if (!isset($_SESSION['login_user']))
    { ?>
